...
if __name__ == "__main__":
  try:
    ...
    print(
        f"Hyperparameters: n_estimators={args.n_estimators}, max_depth={args.max_depth}, random_state={args.random_state}")
    ...
    model = RandomForestClassifier(
        n_estimators=args.n_estimators,  # Usar el del pipeline
